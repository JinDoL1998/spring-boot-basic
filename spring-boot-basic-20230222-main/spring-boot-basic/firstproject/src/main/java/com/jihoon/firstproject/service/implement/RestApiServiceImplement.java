...
import com.jihoon.firstproject.entity.ExampleEntity;
import com.jihoon.firstproject.repository.ExampleRepository;
...
public class RestApiServiceImplement implements RestApiService {
    ...
    public String getMethod() {
        // 데이터 조회
        // 1. JpaRespository에 있는 findBy 메서드로 Entity 조회 
